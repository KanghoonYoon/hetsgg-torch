from hetsgg.modeling.roi_heads.relation_head.rel_proposal_network.loss import FocalLoss
import math
...
from hetsgg.modeling.roi_heads.relation_head.utils_motifs import (
    obj_edge_vectors,
    encode_box_info,
)
from hetsgg.structures.boxlist_ops import boxlist_iou, squeeze_tensor
from hetsgg.utils.global_buffer import store_data
