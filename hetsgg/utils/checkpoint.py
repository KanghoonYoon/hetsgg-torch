...
from hetsgg.utils.c2_model_loading import load_c2_format
from hetsgg.utils.imports import import_file
from hetsgg.utils.model_serialization import load_state_dict
from hetsgg.utils.model_zoo import cache_url
    ...
    def _load_file(self, f):
        ...
        if f.startswith("catalog://"):
            paths_catalog = import_file(
                "hetsgg.config.paths_catalog", self.cfg.PATHS_CATALOG, True
            )
